...
if ( have_posts() ) {
	...
	echo '<span class="privacy-message">I have read and agree to the privacy policy outlined on the privacy page <a href="/privacy" target="_blank" title="View Privacy Page">Privacy Page</a></span>';
	...
	echo '<input type="hidden" name="email-to" value="' . esc_attr( $data['email-to'] ) . '">';
